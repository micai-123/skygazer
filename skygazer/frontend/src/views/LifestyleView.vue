  ...
  <div class="lifestyle-view">
    ...
    <div class="lifestyle-index-grid">
      ...
      >
        ...
        <div class="index-bar">
          <div class="bar-fill" :class="index.levelClass" :style="{ '--width': index.percentage / 100 }"></div>
...
.index-icon.dress-icon {
  background: linear-gradient(135deg, rgba(52, 227, 224, 0.2) 0%, rgba(37, 99, 235, 0.2) 100%);
  color: var(--signal);
}
...
.detail-btn {
  ...
  cursor: pointer;
  transition: all 0.2s ease;
  box-shadow: 0 2px 8px rgba(52, 227, 224, 0.18);
}

.detail-btn:hover {
  transform: translateY(-1px);
  box-shadow: 0 4px 12px rgba(52, 227, 224, 0.28);
}
